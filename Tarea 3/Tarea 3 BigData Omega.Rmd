...
resultado.global <- data.frame(
  "rep" = 1:cantidad.validacion.cruzada,
  "svm" = sapply(MCs.svm, precision.global)*100,
  "k_vecinos" = sapply(MCs.knn, precision.global)*100,
  "bayes" = sapply(MCs.bayes, precision.global)*100,
  "arboles" = sapply(MCs.arbol, precision.global)*100,
  "bosques" = sapply(MCs.bosque, precision.global)*100,
  "potenciacion" = sapply(MCs.potenciacion,precision.global)*100,
  "redes_nnet" = sapply(MCs.red, precision.global)*100,
  "xgboost" = sapply(MCs.xgboost, precision.global)*100,
  "redes_neuralnet" = sapply(MCs.red.neu, precision.global)*100,
  "regresion_logistica" = sapply(MCs.glm, precision.global)*100
  )
